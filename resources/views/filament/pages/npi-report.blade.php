                    ...
                    <table class="w-full text-sm">
                        <thead>
                            <tr class="border-b-2 border-gray-300 dark:border-gray-600">
                                ...
                                <th class="text-right py-2 px-3 font-semibold text-gray-600 dark:text-gray-400" style="width: 100px;">I. Served</th>
                                <th class="text-right py-2 px-3 font-semibold text-gray-600 dark:text-gray-400" style="width: 80px;">II. Target</th>
                                <th class="text-right py-2 px-3 font-semibold text-gray-600 dark:text-gray-400" style="width: 80px;">III. Results</th>
                                <th class="text-right py-2 px-3 font-semibold text-gray-600 dark:text-gray-400" style="width: 80px;">IV. % Ach.</th>
                                <th class="text-right py-2 px-3 font-semibold text-gray-600 dark:text-gray-400" style="width: 80px;">V. Accuracy</th>
                            ...
                            @foreach($this->reportData as $goal)
                                ...
                                @foreach($goal['indicators'] as $indicator)
                                    <tr class="border-b border-gray-100 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-900/50">
                                        ...
                                        <td class="py-2 px-3 text-right {{ ($indicator['individuals_served'] ?? $indicator['unduplicated_clients']) > 0 ? 'font-semibold text-gray-900 dark:text-white' : 'text-gray-400 dark:text-gray-600' }}">
                                            {{ number_format($indicator['individuals_served'] ?? $indicator['unduplicated_clients']) }}
                                        </td>
                                        <td class="py-2 px-3 text-right {{ ($indicator['target'] ?? 0) > 0 ? 'text-gray-700 dark:text-gray-300' : 'text-gray-400 dark:text-gray-600' }}">
                                            {{ number_format($indicator['target'] ?? 0) }}
                                        </td>
                                        <td class="py-2 px-3 text-right {{ ($indicator['actual_results'] ?? 0) > 0 ? 'font-semibold text-green-700 dark:text-green-400' : 'text-gray-400 dark:text-gray-600' }}">
